...
@section('content')
    <div class="py-4">
        <div class="row">
                ...
                <form method="POST" action="{{ route('petugas-pemantauan.store') }}" custom-action="true">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="user_id" name="user_id" >
                            ...
                            @foreach ($user as $a)
                                <option value="{{ $a->id }}"{{old('user_id')==$a->id?'selected':''}}>{{ $a->email }}</option>
                            @endforeach
                        </select>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="phone_number" name="phone_number"
                    placeholder="Masukkan Nomer Telepon" value='{{old('phone_number')}}'>
        ...
        <div class="mb-3">
            ...
            <input class='form-control' type="text" name="address" id="address" placeholder="Masukkan Alamat Petugas"value='{{old('address')}}'>
