                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    value="{{$panduan->title}}" placeholder="Enter title" required>
                                @if ($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="numbers" name="numbers" value="{{(int)$panduan->numbers}}" placeholder="Enter numbers"
                                    required>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea type="description" class="form-control" id="description" name="description" placeholder="Enter description"
                                    required>{{$panduan->description}}</textarea>
