...
@section('content')
    ...
    <div class="py-4">
        <div class="row">
            <div class="">
                <form method="POST" action="{{ route('admin.data-pokok.panduan.store') }}" custom-action="true">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <a href="{{ route('admin.data-pokok.tempat-pemotongan.index') }}" class="btn btn-secondary ms-2">Back</a>
                </form>
            </div>
        </div>
    </div>
