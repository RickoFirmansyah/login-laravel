...
@section('content')
                        ...
                        <div class="card-body text-center p-3">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <img src="{{ asset('assets/images/' . $data['type_of_animal'] . '-removebg-preview.png') }}"
                                        class="img-fluid" alt="Icon Hewan" style='width:55%;'>
                                </div>
                                <div class="col-6">
    ...
    <h3><b>Statistik Hewan Terjangkit Penyakit</b></h3>
    <div id="chart"></div>
    ...
    <div class="d-flex align-items-center justify-content-end">
        ...
        <div class="d-flex align-items-center position-relative my-1">
            <div class="search-box">
                ...
                <input type="text" data-table-id="qurbandata-table" id="search" data-action="search"
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#datarange').daterangepicker({
                    ...
                    $('#datarange span').html(start.format('D MMMM, YYYY') + ' - ' + end.format(
                    'D MMMM, YYYY'));

                    var startDate = start.format('YYYY-MM-DD');
                    var endDate = end.format('YYYY-MM-DD');

                    window.LaravelDataTables['qurbandata2-table'].ajax.url(
                        '?start_date=' + startDate + '&end_date=' + endDate
                    ).load();
                });

                $('#search').on('input', function() {
                    window.LaravelDataTables['qurbandata2-table'].search($(this).val()).draw();
                });
                ...
                $('#export-excel').on('click', function() {
                    window.LaravelDataTables['qurbandata2-table'].button('.buttons-excel').trigger();
                });
            });
