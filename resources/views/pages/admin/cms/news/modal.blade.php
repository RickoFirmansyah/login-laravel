<x-mollecules.modal id="add-news_modal" action="{{ route('admin.cms.news.store') }}">
    ...
    <div class="mb-3">
        ...
        <input id="title" name="title" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Input Judul Berita" required>
      </div>
      <div class="mb-3">
        <label for="exampleFormControlTextarea1" class="form-label">Input Deskripsi Berita</label>
        <textarea id="description" name="description" class="form-control" placeholder="Input Deskripsi Berita" rows="6" required></textarea>
      </div>
