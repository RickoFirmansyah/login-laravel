...
@section('content')
    <div class="py-4">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('system.store') }}" method="POST" custom-action="true">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label" for="name">Nama <span class="text-danger">*</span>
                            </label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" id="value" name="value" placeholder="Enter value">
                            @error('value')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
