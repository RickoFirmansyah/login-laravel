        ...
        <form action="{{ route('menus.update', $menu->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <x-atoms.select2 name="icon" id="icon_field" source="{{ route('icons.ref') }}" :value="old('icon', $menu->icon)" placeholder="Select Icon" custom></x-atoms.select2>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="d-flex justify-content-end mt-3 flex-reverse">
                <a href="{{ route('menus.index') }}" class="btn btn-light me-3" cancel-btn>Kembali</a>
