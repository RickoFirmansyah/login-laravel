                    ...
                    <div class="container-fluid rounded shadow-lg py-1 px-2 px-lg-4 bg-white">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav align-items-center mb-2 mb-lg-0 ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active fw-bold" aria-current="page" href="#statistik">Statistik</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active fw-bold" aria-current="page" href="#berita">Berita</a>
                                </li>
                                <li class="nav-item ms-2">
                                    <a class="btn btn-primary fs-3 rounded btn-hover-shadow px-3 py-2 fw-bolder" href="/login">Masuk</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-5 position-relative d-flex align-items-center vh-100 ">
                            <div class="hero-content mt-11 my-xl-0 ">
                                <div class=" d-grid gap-1 mb-2 py-5 z-index-n2">
                                    <h1 class="fw-bolder fs-72 mb-3" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">Membantu Pantau Hewan Kurban</h1>
                                    <p class="fs-5 text-dark fw-normal" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000"><b>Pantau Ternak</b> hadir untuk memantau</p>
                                </div>
                                <div class="d-sm-flex align-items-center gap-3 z-index-1 mb-11" data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000">
                                    <a class="btn btn-primary btn-hover-shadow d-block mb-3 mb-sm-0" href="#">Daftar
                                        Sekarang<i class=""><img src="{{ asset('landing/images/svgs/ph_sign-in-bold.svg') }}" alt="img-fluid" class="mx-2"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-8 d-none d-xl-block position-absolute end-0 top-0" data-aos="fade-left" data-aos-duration="1000">
                            <img class="object-fit-cover postion-absolute end-0 bottom-0" src="{{ asset('landing/images/hero-img/hero.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="pt-8 px-0 px-xl-11">
                <div class="border rounded">
                    ...
                    <div class=" d-flex justify-content-center align-items-center mb-3">
                        <<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2990.274257380938!2d-70.56068388481569!3d41.45496659976631!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89e52963ac45bbcb%3A0xf05e8d125e82af10!2sDos%20Mas!5e0!3m2!1sen!2sus!4v1671220374408!5m2!1sen!2sus" width="1700" height="650" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded "></iframe>
                    </div>
                </div>
            </section>
            <!--  Map End  -->
            ...
            <section class="pt-5 px-0 px-xl-11 bg-statistic vh-100 d-flex flex-column justify-content-between ">
                ...
                <div class="row mb-10 text-center">
                    ...
                    <div class="col-xl-2 position-relative d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('landing/images/statistic/cow.png') }}" style="width: 120px ; height: 120px" alt="img-fluid">
                            </div>
                    ...
                    <div class="col-xl-2 position-relative d-flex align-items-center justify-content-center ">
                        <div class="d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('landing/images/statistic/village.png') }}" style="width: 120px ; height: 120px" alt="img-fluid">
                            </div>
                    ...
                    <div class="col-xl-2 position-relative d-flex align-items-center justify-content-center ">
                        <div class="d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('landing/images/statistic/department.png') }}" style="width: 120px ; height: 120px" alt="img-fluid">
                            </div>
                    ...
                    <div class="col-xl-2 position-relative d-flex align-items-center justify-content-center ">
                        <div class="d-flex flex-column justify-content-between">
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset('landing/images/statistic/farm.png') }}" style="width: 120px ; height: 120px" alt="img-fluid">
                            </div>
