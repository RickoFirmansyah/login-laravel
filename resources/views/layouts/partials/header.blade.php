                ...
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
                    <li class="nav-item dropdown">
                        <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                            ...
                            <img src="{{ asset('assets/images/svgs/icon-flag-en.svg') }}" alt=""
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                            <div class="message-body" data-simplebar>
                                ...
                                <a href="javascript:void(0)"
                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/svgs/icon-flag-cn.svg') }}" alt=""
                                            class="rounded-circle object-fit-cover round-20">
                                    </div>
                                ...
                                <a href="javascript:void(0)"
                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/svgs/icon-flag-fr.svg') }}" alt=""
                                            class="rounded-circle object-fit-cover round-20">
                                    </div>
                                ...
                                <a href="javascript:void(0)"
                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                    <div class="position-relative">
                                        <img src="{{ asset('assets/images/svgs/icon-flag-sa.svg') }}" alt=""
                                            class="rounded-circle object-fit-cover round-20">
                                    </div>
                            ...
                            <div class="profile-dropdown position-relative" data-simplebar>
                                ...
                                <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <span class="mb-1 d-block text-dark">{{ $currentUser->roles[0]->name }}</span>
                                ...
                                <div class="d-grid py-4 px-7 pt-8">
                                    @auth
                                        @if (Auth::user()->isImpersonated())
                                            <a href="{{ route('leaveImpersonation') }}" class="btn btn-outline-primary px-5">End
                                                Impersonation</a>
                                        @else
